      ...
      {isModalOpen && (
        <div className="modal text-left">
          <div className="modal-content ">
            ...
            <input type="text" placeholder="Please enter your Train ID" />
            <label>NIC</label>
            <input type="text" placeholder="Please enter your NIC" />
            <label>Date of booking</label>
            <input type="text" placeholder="Please enter the booking date" />
            <label>Date of reservation</label>
            <input
              type="text"
              placeholder="Please enter the reservation date"
            />
